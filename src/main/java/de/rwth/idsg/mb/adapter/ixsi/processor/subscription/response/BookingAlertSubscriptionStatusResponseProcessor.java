 ...
 */
@Stateless
public class BookingAlertSubscriptionStatusResponseProcessor
        implements SubscriptionResponseProcessor<BookingAlertSubscriptionStatusRequestType,
                                                 BookingAlertSubscriptionStatusResponseType> {
    ...
    @Override
    public Class<BookingAlertSubscriptionStatusResponseType> getProcessingClass() {
        return BookingAlertSubscriptionStatusResponseType.class;
    }

    @Override
    @ErrorLog
    public void process(InOutContext<BookingAlertSubscriptionStatusRequestType,
                                     BookingAlertSubscriptionStatusResponseType> context) {
