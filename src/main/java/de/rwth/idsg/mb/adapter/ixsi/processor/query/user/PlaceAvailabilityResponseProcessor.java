...
@Slf4j
@Stateless
public class PlaceAvailabilityResponseProcessor
        implements UserResponseProcessor<PlaceAvailabilityRequestType, PlaceAvailabilityResponseType> {

    @Override
    public IxsiFeature getRelatedFeature() {
        return IxsiFeature.QU_PlaceAvailability;
    }

    @Override
    public Class<PlaceAvailabilityResponseType> getProcessingClass() {
        return PlaceAvailabilityResponseType.class;
    }

    @Override
    @ErrorLog
    public void process(UserInOutContext<PlaceAvailabilityRequestType, PlaceAvailabilityResponseType> context) {
