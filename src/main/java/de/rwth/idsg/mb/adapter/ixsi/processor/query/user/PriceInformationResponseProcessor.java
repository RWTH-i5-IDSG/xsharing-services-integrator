...
@Slf4j
@Stateless
public class PriceInformationResponseProcessor
        implements UserResponseProcessor<PriceInformationRequestType, PriceInformationResponseType> {

    @Override
    public IxsiFeature getRelatedFeature() {
        return IxsiFeature.QU_PriceInformation;
    }

    @Override
    public Class<PriceInformationResponseType> getProcessingClass() {
        return PriceInformationResponseType.class;
    }

    @Override
    @ErrorLog
    public void process(UserInOutContext<PriceInformationRequestType, PriceInformationResponseType> context) {
