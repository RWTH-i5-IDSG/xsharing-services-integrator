 ...
 */
@Stateless
public class AvailabilitySubscriptionStatusResponseProcessor
        implements SubscriptionResponseProcessor<AvailabilitySubscriptionStatusRequestType,
                                                 AvailabilitySubscriptionStatusResponseType> {
    ...
    @Override
    public Class<AvailabilitySubscriptionStatusResponseType> getProcessingClass() {
        return AvailabilitySubscriptionStatusResponseType.class;
    }

    @Override
    @ErrorLog
    public void process(InOutContext<AvailabilitySubscriptionStatusRequestType,
                                     AvailabilitySubscriptionStatusResponseType> context) {
        ...
        subscriptionStore.replaceSubscriptions(partnerId, context.getIncoming().getBookingTargetID());
    }
}
