...
@Slf4j
@Stateless
public class TokenGenerationResponseProcessor
        implements UserResponseProcessor<TokenGenerationRequestType, TokenGenerationResponseType> {

    @Override
    public IxsiFeature getRelatedFeature() {
        return IxsiFeature.QU_TokenGeneration;
    }

    @Override
    public Class<TokenGenerationResponseType> getProcessingClass() {
        return TokenGenerationResponseType.class;
    }

    @Override
    @ErrorLog
    public void process(UserInOutContext<TokenGenerationRequestType, TokenGenerationResponseType> context) {
