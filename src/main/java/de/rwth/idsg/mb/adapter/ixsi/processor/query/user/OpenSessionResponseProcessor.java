...
@Slf4j
@Stateless
public class OpenSessionResponseProcessor
        implements UserResponseProcessor<OpenSessionRequestType, OpenSessionResponseType> {

    @Override
    public IxsiFeature getRelatedFeature() {
        return IxsiFeature.QU_OpenSession;
    }

    @Override
    public Class<OpenSessionResponseType> getProcessingClass() {
        return OpenSessionResponseType.class;
    }

    @Override
    @ErrorLog
    public void process(UserInOutContext<OpenSessionRequestType, OpenSessionResponseType> context) {
